...
/// <summary>
/// A log level (or aspect) that indicates the severity of a log message (immutable).<br/>
...
public sealed class LogLevel
{
	...
	/// </summary>
	public static readonly LogLevel Emergency = new("Emergency");

	/// <summary>
	/// Alert: Something bad happened, immediate attention is required.
	/// </summary>
	public static readonly LogLevel Alert = new("Alert");

	/// <summary>
	/// Critical: Something bad is about to happen, immediate attention is required.
	/// </summary>
	public static readonly LogLevel Critical = new("Critical");
	...
	/// </summary>
	public static readonly LogLevel Warning = new("Warning");

	/// <summary>
	/// Notice: Normal but significant condition that might need special handling.
	/// </summary>
	public static readonly LogLevel Notice = new("Notice");

	/// <summary>
	/// Informational: Informative but not important.
	/// </summary>
	public static readonly LogLevel Informational = new("Informational");
	...
	/// </summary>
	public static readonly LogLevel Trace = new("Trace");

	/// <summary>
	/// Timing: Aspect that is used when timing is concerned.
	/// </summary>
	public static readonly LogLevel Timing = new("Timing");
	...
	/// </summary>
	public static readonly LogLevel None = new("None", -1);

	/// <summary>
	/// All: Special log level expressing the highest possible threshold for filtering purposes
	/// (all log levels pass the filter). Using this log level to write messages is not allowed.<br/>
	/// A message written with this log level will be mapped to log level <see cref="Error"/>,
	/// a notice about this incident will be attached to the message text.<br/>
	/// The message will then bypass any filters induced by the configuration.
	/// </summary>
	public static readonly LogLevel All = new("All", int.MaxValue);
	...
	/// <summary>
	/// Gets all log levels that are currently known (except log level 'None' and 'All').<br/>
	...
	/// <summary>
	/// Raises the <see cref="NewLogLevelRegistered"/> event.<br/>
